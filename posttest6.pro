...
PREDICATES
nondeterm lakukan(pohonchar) 	%lakukan dgn argumen pohonchar, Keywoard nondeterm pada section PREDICATES yang mendahului predikat orang berfungsi untuk memberitahu ke compiler Visual Prolog
...
GOAL
write("**"),nl, %menampilkan kalimatnya di layar output,nextline(baris baru) 
